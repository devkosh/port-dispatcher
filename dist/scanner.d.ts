import type { PortEntry, PortRange, ScanResult, DbScanResult } from './types.js';
...
export declare const KNOWN_DATABASES: {
    name: string;
    ports: number[];
}[];
export declare function scanDatabases(): DbScanResult;
